...
- [x] Define admin bootstrap flow and prevent public admin registration.
- [x] Add admin-only user listing and role update APIs.
- [x] Enforce admin/member access rules with backend tests.
- [x] Build settings page with Profile, System, and Account sections.
- [x] Implement username/email/password update flows.
- [x] Apply the reference-inspired light mode UI direction across the project.
- [x] Add whole-app Bangla/English language switching with persistence.
- [x] Add Delete My Account confirmation modal.
- [x] Implement user soft delete and block deleted-user login/refresh.
- [x] Hide soft-deleted users' tasks from normal task views.
- [x] Add frontend and backend tests for settings, roles, language, soft delete, and UI behavior.
...
- 2026-05-22: Implemented admin role management, account settings, BN/EN language support, soft delete, and light-mode UI polish.
